package com.phptravels.StepDefinationFiles.DataTableSD;
...
public class DataTableSD  {
	...
	public void enter_Credentials(DataTable dataTable){
    	...
    	//Row and Column Number starts from zero
    	System.out.println("UserName : " + data.get(1).get(0) + " Password : " +  data.get(1).get(1));
    	
    	driver.findElement(By.xpath("//input[@name='email']")).sendKeys(data.get(1).get(0));
		driver.findElement(By.xpath("//input[@name='pass']")).sendKeys(data.get(1).get(1));
	}
